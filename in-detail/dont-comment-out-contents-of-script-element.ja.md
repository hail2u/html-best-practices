...
こうすることで未熟なブラウザーがスクリプトをそのまま画面に表示してしまうということを避けられます。そういった意味では一定の効果はあると言えますが、そのようなブラウザーの数は考慮に値するほど存在していません。また現在のHTML仕様に従って書く以上、それらのブラウザーが適切に解釈してくれるとは考えられません。いずれにしてもコメントアウトしてやる意味はもうないと言えるでしょう。
